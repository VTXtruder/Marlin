...
#define STRING_CONFIG_H_AUTHOR "(Noel Jacques, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Crushinator"
...
#if EITHER(SWITCHING_TOOLHEAD, MAGNETIC_SWITCHING_TOOLHEAD, ELECTROMAGNETIC_SWITCHING_TOOLHEAD)
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 29.9424
    #define DEFAULT_Ki 2.3764
    #define DEFAULT_Kd 94.3185
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 233.0675
  #define DEFAULT_bedKi 34.8903
  #define DEFAULT_bedKd 1037.9274
...
#if EITHER(PIDTEMP, PIDTEMPBED, PIDTEMPCHAMBER)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35.33, 9.45, 0 }
...
#if EITHER(MESH_BED_LEVELING, AUTO_BED_LEVELING_UBL, PROBE_MANUALLY)
  // Set a height for the start of manual adjustment
  #define MANUAL_PROBE_START_Z 0.2  // (mm) Comment out to use the last-measured height
#endif

#if EITHER(MESH_BED_LEVELING, AUTO_BED_LEVELING_BILINEAR, AUTO_BED_LEVELING_UBL)
  /**
...
#if EITHER(RGB_LED, RGBW_LED, PCA9632)
 ...
 */
#if EITHER(BLINKM, RGB_LED, RGBW_LED, PCA9632, PCA9533, NEOPIXEL_LED)
